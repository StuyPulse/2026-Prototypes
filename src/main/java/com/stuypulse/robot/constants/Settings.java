...
public interface Settings {
    ...
    public interface Intake { //TODO: !! Make suppliers and Smart numbers so that it can be edited through glass
        ...
        static SmartNumber STOW = new SmartNumber("INTAKE SETTINGS/ ROLLER/ STOW (CHANGEABLE)", 0); //TODO: double check IRL, this works in Sim!!
        ...
        static SmartNumber UP = new SmartNumber("INTAKE SETTINGS/ POSITIONAL/ UP (CHANGEABLE)", 90); //TODO: update values with accurate angles
        static SmartNumber DOWN = new SmartNumber("INTAKE SETTINGS/ POSITIONAL/ DOWN (CHANGEABLE)", 180);  
